...
import com.holparb.coinflow.R
import com.holparb.coinflow.crypto.presentation.coin_detail.components.InfoCard
import com.holparb.coinflow.crypto.presentation.coin_detail.components.LineChart
import com.holparb.coinflow.crypto.presentation.coin_list.CoinListState
...
import com.holparb.coinflow.crypto.presentation.model.toDisplayableNumber
    ...
    if(state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                val imageVectorId = if(isPositive) R.drawable.trending else R.drawable.trending_down
                InfoCard(
                    title = stringResource(R.string.change_last_24h),
                    formattedText = "$ ${absoluteChangeFormatted.formattedValue}",
                    icon = ImageVector.vectorResource(id = imageVectorId),
...
private fun CoinDetailScreenPreview() {
    CoinFlowTheme {
        CoinDetailScreen(
            state = CoinListState(selectedCoin = previewCoin.toCoinUi()),
